     ...
     if ($cloneResult.Success) {
        ...
        if ($cloneResult.ExitCode -eq 128) {
            ...
            if ($RemoteUrl -like "git@*" -or $RemoteUrl -like "ssh://*") {
                ...
                Write-Host "     .\STEP5_setup-prod-repo.ps1 -RemoteUrl \"https://github.com/trimble-transport/ttc-ctp-custint-exchange-platform-monolith.git\"" -ForegroundColor White
                ...
                Write-Host "     .\STEP5_setup-prod-repo.ps1" -ForegroundColor White
            }
        } else {
